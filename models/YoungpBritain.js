...
var Youngbritain = new keystone.List('Youngbritain', {
	label: 'Young Persons',
...
Youngbritain.track = true;
Youngbritain.defaultColumns = 'name|20%, dob|15%, nationality|10%, supportReasons|20%';
Youngbritain.register();
